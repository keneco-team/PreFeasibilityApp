import{a as ea}from"./devEnvironmentUtils-D6qIi8Ky.js";import{dZ as Mi,nE as ta,nF as ra,c5 as Kr,d_ as ia,jB as oa,cb as Ci,b1 as Ge,ey as Dt,ix as xr,b0 as M,iw as aa,hZ as Oi,cS as Me,hx as fe,aZ as Mr,fx as j,cT as me,eA as pe,nG as na,cU as Ce,_ as St,eX as sa,x as Cr,s as Et,df as la,d7 as Qr,ky as ca,gT as ht,l3 as mt,b5 as ei,nH as da,hM as ua,hN as ha,fq as zt,kK as ma,hm as yt,iy as Ne,eR as fa,l$ as pa,a5 as Ri,nI as va,bV as ga,cZ as it,nJ as xa,nK as Ta,cV as Ft,a$ as Yt,hy as Ze,hw as Gt,nL as Ii,nM as Pi,at as _a,e5 as Xt,l0 as Tr,y as m,e0 as $i,aO as oe,hu as Or,ir as Rr,z as G,A as Ir,S as Li,nN as Ni,by as Di,bz as ba,ft as Ve,fp as Jt,is as Sa,ak as Ot,h5 as _r,aY as Ea,e3 as ya,P as Aa,nO as wa,io as Fi,U as Ma,ch as Bi,hP as zi,nP as Gi,iS as Vt,e1 as ti,e2 as Ca,eb as Oa,m1 as ri}from"./index-Cey3Bnmd.js";import{t as lr,e as At,o as ct}from"./mat3f64-q3fE-ZOt.js";import{o as Ut,r as Ra,e as Zt}from"./mat4f64-CSKppSlJ.js";import{x as Kt,c as br,y as Ia,u as Pa,q as $a,i as jt,L as La,O as Na,E as Da}from"./BufferView-BGJ71b9y.js";import{e as Fa,f as Ba,l as ii,o as oi}from"./vec3-BJ9vVGCJ.js";import{n as za,s as ai}from"./vec4-B1i2I-vA.js";import{l as Ga,n as Va,g as qe,o as Ua,h as ja,t as Ha,i as Wa}from"./DefaultMaterial_COLOR_GAMMA-3LcLRglV.js";import{r as cr}from"./resourceUtils-C5YmYO8m.js";import{t as qa}from"./NestedMap-DgiGbX8E.js";import{t as ka,l as Vi}from"./Indices-C-SpEGUQ.js";import{t as Ui}from"./requestImageUtils-BKaWQNSY.js";import{I as Ya,L as Xa,t as Xe}from"./orientedBoundingBox-mFuw1etZ.js";import{t as Ja,u as vt,a as Sr,i as Za,N as Oe,s as J,O as ji,e as Re,n as wt}from"./basicInterfaces-DngWxyLO.js";import{s as q}from"./Util-CK4q9L4u.js";import{s as Hi,_ as Wi,V as Ae}from"./sphere-DFlISun4.js";import{v as Ka}from"./lineSegment-D5bN_7W7.js";import"./plane-Ck7uReXx.js";import{e as f}from"./VertexAttribute-BlT9lbVY.js";import{c as Ee,G as Fe,L as nt,D as Ue,R as we,O as ve,X as ni,E as Qa,I as ne,t as en,_ as tn,f as rn}from"./enums-BlUEVwJR.js";import{c as ot,a as on,e as qi,d as an}from"./Texture-B_FmNQEr.js";import{H as nn}from"./InterleavedLayout-7ZDrN15f.js";import{n as be,a as K,t as Qt,o as B,b as dr,r as ur}from"./NormalAttribute.glsl-B6jGIPpr.js";import{o as s,n as Mt}from"./interfaces-B8ge7Jg9.js";import{l as ki,S as Pr,_ as $r,h as sn,o as ln}from"./renderState-C37QfRey.js";import{a as D}from"./BindType-BmZEZMMh.js";import{o as cn,r as dn}from"./doublePrecisionUtils-B0owpBza.js";import"./quat-CmJwkiuX.js";import"./quatf64-Bdb9ZJJK.js";import"./spatialReferenceEllipsoidUtils-DiFxLxw2.js";import"./computeTranslationToOriginAndRotation-CY8oYY1j.js";import"./types-D0PSWh4d.js";function Rt(t,e=!1){return t<=Mi?e?new Array(t).fill(0):new Array(t):new Float32Array(t)}function un(t){t.vertex.code.add(s`
...
}`)}function Tl(t,e){switch(e.output){case B.Shadow:case B.ShadowHighlight:case B.ShadowExcludeHighlight:case B.ViewshedShadow:t.fragment.include(Io),t.fragment.code.add(s`float _calculateFragDepth(const in float depth) {
...
color.a = 1.0;
}`);break;case J.Mask:i.code.add(s`#define discardOrAdjustAlpha(color) { if (color.a < textureAlphaCutoff) { discard; } else { color.a = 1.0; } }`);break;case J.MaskBlend:t.fragment.code.add(s`#define discardOrAdjustAlpha(color) { if (color.a < textureAlphaCutoff) { discard; } }`)}}function Po(t,e){const{vertex:r,fragment:i}=t,a=e.hasColorTexture&&e.alphaDiscardMode!==J.Opaque;switch(e.output){case B.Depth:et(r,e),t.include(Qe,e),t.include(Ke,e),t.include(ze,e),a&&i.uniforms.add(new Q("tex",o=>o.texture)),r.code.add(s`void main(void) {
...
forwardTextureCoordinates();
        ...
        `);break;case B.Shadow:case B.ShadowHighlight:case B.ShadowExcludeHighlight:case B.ViewshedShadow:case B.ObjectAndLayerIdColor:et(r,e),t.include(Qe,e),t.include(ze,e),t.include(_t,e),t.include(Tl,e),t.include(Ke,e),t.include(xl,e),xo(t),t.varyings.add("depth","float"),a&&i.uniforms.add(new Q("tex",o=>o.texture)),r.code.add(s`void main(void) {
vpos = getVertexInLocalOriginSpace();
vpos = subtractOrigin(vpos);
vpos = addVerticalOffset(vpos, localOrigin);
...
return max(c.x, max(c.y, c.z));
  ...
  `)}function Xo(t){const e=new rr,{vertex:r,fragment:i,varyings:a}=e;if(et(r,t),e.include(Fr),a.add("vpos","vec3"),e.include(_t,t),e.include(wo,t),e.include(Ro,t),e.include(ic,t),t.output===B.Color){e.include(oc,t),e.include(ac,t),e.include(nc,t),e.include(sc,t),bt(r,t),e.include(Qt,t),e.include(Qe,t);const o=t.normalType===K.Attribute||t.normalType===K.Compressed;o&&t.offsetBackfaces&&e.include(bo),e.include(Ml,t),e.include(vo,t),t.instancedColor&&e.attributes.add(f.INSTANCECOLOR,"vec4"),a.add("vPositionLocal","vec3"),e.include(ze,t),e.include(_o,t),e.include(Co,t),e.include(Oo,t),r.uniforms.add(new te("externalColor",n=>n.externalColor)),a.add("vcolorExt","vec4"),t.multipassEnabled&&a.add("depth","float"),r.code.add(s`
      void main(void) {
